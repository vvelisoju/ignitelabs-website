...
onSuccess, // Destructure the onSuccess prop
    ...
    return (_jsxs(Dialog, { open: controlledOpen, onOpenChange: setOpen, children: [buttonText && (_jsx(DialogTrigger, { asChild: true, children: _jsxs(Button, { variant: buttonVariant, size: buttonSize, className: `group ${buttonClassName}`, children: [buttonText, buttonIcon] }) })), _jsxs(DialogContent, { className: "sm:max-w-md max-h-[80vh] md:max-h-[90vh] overflow-hidden", children: [_jsxs(DialogHeader, { className: "pb-2", children: [_jsx(DialogTitle, { children: title || getDefaultTitle() }), _jsx(DialogDescription, { children: description || getDefaultDescription() })] }), _jsx("div", { className: "overflow-y-auto pr-2 max-h-[calc(80vh-10rem)] md:max-h-[calc(90vh-10rem)]", children: _jsx(LeadCaptureForm, { formType: formType, onSuccess: handleSuccess, onCancel: () => setOpen(false), extraData: extraData, defaultMessage: defaultMessage }) })] })] }));
}
